...
const ImageBazzar = () => {
  ...
  const images =[
    { src: "./public/image/p1.jpg", alt: "Healthcare" },
    { src: "./public/image/p2.jpg", alt: "Travel" },
    { src: "./public/image/p3.jpg", alt: "Beauty", },
    { src: "./public/image/p4.jpg", alt: "Business" },
    { src: "./public/image/p5.jpg", alt: "Family" },
    { src: "./public/image/p6.jpg", alt: "Beach" },
    { src: "./public/image/p7.jpg", alt: "Friends" },
    { src: "./public/image/p8.jpg", alt: "Friends" },
    { src: "./public/image/p9.jpg", alt: "Friends" },
    { src: "./public/image/p10.jpg", alt: "Friends" },
    { src: "./public/image/p11.jpg", alt: "Friends" },
    { src: "./public/image/p12.jpg", alt: "Friends" },
    { src: "./public/image/p13.jpg", alt: "Friends" },
    { src: "./public/image/p14.jpg", alt: "Friends" },
    { src: "./public/image/p15.jpg", alt: "Friends" },
    { src: "./public/image/p16.jpg", alt: "Friends" },
    { src: "./public/image/p17.jpg", alt: "Friends" },
    { src: "./public/image/p18.jpg", alt: "Friends" },
